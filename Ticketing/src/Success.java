...
public class Success extends JPanel implements ActionListener{
	...
	JRadioButton rad_card = new JRadioButton("½Å¿ëÄ«µå", false);
	JRadioButton rad_deposit = new JRadioButton("¹«ÅëÀåÀÔ±Ý", false);
	...
	Success(){
		...
		lb_money.setFont(new Font("¸¼Àº °íµñ",Font.BOLD,14));
		rad_card.setFont(new Font("¸¼Àº °íµñ",Font.BOLD,14));
		rad_deposit.setFont(new Font("¸¼Àº °íµñ",Font.BOLD,14));
		rad_card.setBackground(Color.WHITE);
		rad_deposit.setBackground(Color.WHITE);
		
		JLabel l_seatnum = new JLabel("ÁÂ¼®¹øÈ£ : ");
		JLabel l_area=new JLabel("±¸¿ª");
		JLabel lb_seatnum=new JLabel("¹ø");
		JLabel area=new JLabel();
		JLabel seatnum=new JLabel();
		
		JLabel show = new JLabel("°ø¿¬¸í : ");
		JLabel showname=new JLabel();
		
		JLabel watch = new JLabel("°ü¶÷ÀÏ½Ã : ");
		...
		seatnum.setFont(new Font("¸¼Àº °íµñ",Font.BOLD,14));
		show.setFont(new Font("¸¼Àº °íµñ",Font.BOLD,14));
		showname.setFont(new Font("¸¼Àº °íµñ",Font.BOLD,14));
		watch.setFont(new Font("¸¼Àº °íµñ",Font.BOLD,14));
