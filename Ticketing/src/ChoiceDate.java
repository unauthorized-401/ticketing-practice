...
public class ChoiceDate extends JPanel implements ActionListener{
	...
	ChoiceDate(){
		...
		JFrame jf = new JFrame("°ü¶÷ÀÏ, È¸Â÷ ¼±ÅÃÃ¢");
		...
		JLabel lb_episode = new JLabel("È¸");
		
		lb_month.setFont(new Font("¸¼Àº °íµñ",Font.PLAIN,16));
		lb_day.setFont(new Font("¸¼Àº °íµñ",Font.PLAIN,16));
		lb_episode.setFont(new Font("¸¼Àº °íµñ",Font.PLAIN,16));
